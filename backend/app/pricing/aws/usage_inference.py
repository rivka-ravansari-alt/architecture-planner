"""Infer AWS usage assumptions from project fields and component mappings."""
...
__all__ = ["AwsUsageInferenceEngine", "InferenceMode"]


class AwsUsageInferenceEngine:
    """Facade delegating to UsageAssumptionsService for AWS."""
