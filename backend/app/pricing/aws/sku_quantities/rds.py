...
_REQUIRED_KEYS = ["instance_class", "storage_gb", "hours_per_month"]

_FREE_TIER_INCLUDED_STORAGE_GB = 20.0


def calculate_rds_quantities(
    ...
    included_usage: list[IncludedUsage] = [
        IncludedUsage(
            ...
            unit="GB-months",
            description="Storage included in AWS Free Tier for eligible instance classes.",
            source="tier",
        )
    ]
