"""Infer GCP usage assumptions from project fields and component mappings."""
...
__all__ = ["GcpUsageInferenceEngine", "InferenceMode"]


class GcpUsageInferenceEngine:
    """Facade delegating to UsageAssumptionsService for GCP."""
    ...
    def infer_components(
        ...
        *,
        ...
        return self._service.infer_components(
            ...
            inference_mode=inference_mode or "heuristic",
        )
